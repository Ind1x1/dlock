...
class RendezvousManager(metaclass=ABCMeta):
    ...
    def join_rendezvous(
        ...
        Args:
            node_id: the node ID which is unique in an ElasticJob of dlock.
...
class ElasticTrainingRendezvousManager(RendezvousManager):
    """ElasticTrainingRendezvousManager runs on the dlock master. The manager
    ...
    Elasticjob of dlock, the node has an unique node ID.
    """
...
class NetworkCheckRendezvousManager(RendezvousManager):
    """NcclCheckRendezvousManager runs on the dlock master. The task
