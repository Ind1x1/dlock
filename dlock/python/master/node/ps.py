...
class ParameterServerManager(TrainingNodeManager):
    ...
    def _wait_ps_node(self, node: Node):
        ...
        return (
            ...
            and not node.timeout(_dlock_ctx.seconds_to_wait_failed_ps)
    ...
    def has_ps_failure(self):
        ...
        for node in ps_nodes.values():
            if node.timeout(_dlock_ctx.seconds_to_wait_failed_ps):
                return True
        return False
    ...
    def get_ps_addrs(self):
        ...
        for ps in list(nodes.values()):
            if (
                ...
                and not ps.timeout(_dlock_ctx.seconds_to_wait_failed_ps)
            ):
    ...
    def is_training_hang_by_pending(self, total_node_num, job_type) -> bool:
        ...
        # fail strategy
        strategy = _dlock_ctx.pending_fail_strategy
