...
from dlock.python.common.constants import ConfigPath
from dlock.python.common.log import default_logger as logger
from dlock.python.common.serialize import JsonSerializable
from dlock.trainer.torch.elastic.dataloader import ElasticDataLoader
...
class ElasticTrainer(object):
    ...
    **Available attributes:**
    ...
    def step(self, fix_total_batch_size=False):
        ...
        Example:
        ```python
        >>> from dlock.trainer.torch.elastic.trainer import ElasticTrainer
