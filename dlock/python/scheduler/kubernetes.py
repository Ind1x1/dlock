...
NODE_SERVICE_PORTS = {
    ...
    NodeType.DLOCK_MASTER: 50001,
}

JOB_SUFFIX = "-edljob-"
USER_AGENT = "dlock/29.0.0/python"
...
class k8sClient(Singleton):
    def __init__(self, namespace):
        ...
        Args:
            image_name: Docker image path for dlock pod.
            namespace: The name of the Kubernetes namespace where dlock
...
class K8sElasticJob(ElasticJob):
    def __init__(self, job_name, namespace):
        ...
        Args:
            ...
            namespace: The name of the Kubernetes namespace where dlock
                pods will be created.
            job_name: dlock job name, should be unique in the namespace.
