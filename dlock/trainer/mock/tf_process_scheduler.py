...
from dlock.trainer.mock.base_process_scheduler import BaseProcessScheduler
from dlock.trainer.util.log_util import default_logger as logger
from dlock.trainer.util.net_util import get_available_port
...
def mock_ray_platform_subprocess(tf_config):
    ...
    worker_argv = [sys.executable, "-m", "dlock.trainer.entry.local_entry"]
