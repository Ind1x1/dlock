...
import dlock.python.util.file_util as fu
...
class SharedMemoryHandler(object):
    ...
    def save_state_dict(self, state_dict):
        ...
        ckpt_conf: CheckpointConfig = meta_dict[DLOCK_CKPT_CONFIG_KEY]
    ...
    def load_state_dict(self):
        ...
        config = meta_dict.get(DLOCK_CKPT_CONFIG_KEY, default_config)
    ...
    def no_checkpoint_state(self):
        ...
        """
        meta_dict = self.metadata.get()
        config: CheckpointConfig = meta_dict.get(DLOCK_CKPT_CONFIG_KEY, None)
