...
from dlock.python.elastic_agent.tensorflow.elastic_ps import ElasticPsClient
...
class FailoverClient:
    """
    FailoverClient interacts with dlock master.
    ...
    def ready_for_ps_relaunch(self):
        logger.info("Noticing dlock master that it's ready for ps relaunch")
