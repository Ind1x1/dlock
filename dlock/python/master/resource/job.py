...
from dlock.python.brain.client import GlobalBrainClient
...
from dlock.python.common.node import Node, NodeGroupResource, NodeResource
from dlock.python.common.serialize import JsonSerializable
from dlock.python.master.resource.brain_optimizer import (
    BrainResoureOptimizer,
)
from dlock.python.master.resource.local_optimizer import PSLocalOptimizer
from dlock.python.master.resource.optimizer import (
    ResourcePlan,
    SimpleOptimizer,
)
from dlock.python.scheduler.job import ResourceLimits
...
class PSJobResourceOptimizer(JobResourceOptimizer):
    ...
    def _init_job_resource_by_optimizer(self):
        ...
        if (
            _dlock_context.auto_worker_enabled
        ...
        if (
            _dlock_context.auto_ps_enabled
    ...
    def _get_ps_resource_plan(self, optimizer_config={}):
        ...
        interval = _dlock_context.seconds_interval_to_change_ps
