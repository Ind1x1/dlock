...
class NodeType(object):
    ...
    EVALUATOR = "evaluator"
    CHIEF = "chief"
    DLOCK_MASTER = "dlock-master"


class ElasticJobLabel(object):
    APP_NAME = "dlock"
    JOB_KEY = "elasticjob.dlock/name"
    REPLICA_TYPE_KEY = "elasticjob.dlock/replica-type"
    REPLICA_INDEX_KEY = "elasticjob.dlock/replica-index"
    RANK_INDEX_KEY = "elasticjob.dlock/rank-index"
    RELAUNCH_COUNT = "elasticjob.dlock/relaunch-count"
...
class NodeEnv(object):
    ...
    DLOCK_MASTER_ADDR = "DLOCK_MASTER_ADDR"
...
class ConfigPath(object):
    ENV_PARAL_CONFIG = "DLOCK_PARAL_CONFIG_PATH"
    PARAL_CONFIG = "/tmp/dlock/auto_paral_config.json"
    ENV_RUNTIME_METRICS = "RUNTIME_METRICS_PATH"
    RUNTIME_METRICS = "/tmp/dlock/runtime_metrics.json"
    NETWORK_CHECK_DATA_DIR = "/tmp/dlock/network_check/"


class CheckpointConstant(object):
    TRACER_FILE_NAME = "dlock_latest.txt"
