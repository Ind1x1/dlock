    ...
    def _scale_up_actors(
        ...
        if v.count > 0:
            ...
            TFRayWorker = get_class(
                "dlock.trainer.worker.tf_ray_worker.TFRayWorker"
            )
