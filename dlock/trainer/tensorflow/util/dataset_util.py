...
from dlock.trainer.tensorflow.reader.base_reader import ElasticReader
from dlock.trainer.tensorflow.util.column_info import Column
...
class DatasetUtil(object):
    ...
    def create(
        ...
        """
        Args:
            task_conf: dlock.trainer task conf
