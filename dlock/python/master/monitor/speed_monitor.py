...
from dlock.python.common.constants import ErrorMonitorConstants
...
class SpeedMonitor(object):
    ...
    def __init__(self, error_monitor: ErrorMonitor = None):
        ...
        self._max_record_count = _dlock_context.train_speed_record_num
        self._global_step = 0
    ...
    def worker_adjustment_finished(self):
        ...
        for record in reversed(self._global_step_records):
            if (
                ...
                >= _dlock_context.seconds_for_stable_worker_count
            ):
                return True
        return False
