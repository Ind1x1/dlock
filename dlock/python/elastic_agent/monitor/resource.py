...
from dlock.python.common.constants import NodeEnv
from dlock.python.common.grpc import GPUStats
...
class ResourceMonitor(Singleton):
    def __init__(self):
        ...
        reports the used memory and cpu percent to the dlock master.
        """
        ...
        if os.getenv(NodeEnv.DLOCK_MASTER_ADDR, ""):
    ...
    def start(self):
        if not os.getenv(NodeEnv.DLOCK_MASTER_ADDR, ""):
            return
