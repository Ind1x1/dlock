...
from dlock.proto import brain_pb2, brain_pb2_grpc
from dlock.python.common.grpc import build_channel, grpc_server_ready
...
_ENV_BRAIN_ADDR_KEY = "DLOCK_BRAIN_SERVICE_ADDR"
_DEFAULT_BRAIN_ADDR = "dlock-brain.dlock.svc.cluster.local:50001"
