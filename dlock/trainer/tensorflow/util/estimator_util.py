...
from dlock.python.elastic_agent.sychronization.sync_client import SyncClient
from dlock.trainer.constants.tf_constants import TFConstants
from dlock.trainer.tensorflow.util import common_util
from dlock.trainer.tensorflow.util.tf_env_util import (
...
def hook_estimator_call_model_fn(params=None):
    ...
    def dlock_call_model_fn(*args, **kwargs):
    ...
    Estimator._call_model_fn = dlock_call_model_fn
